...
The Sepolia `cUSDTMock` target is verified for the bounded prototype. Earlier pool `0xa4f2c74Fe1325e218AC9cEDc176DA7C4e175f3a2` completed the original bounded lifecycle, and hardened fixed-epoch pool `0xF99747C771c09909f6Ad56F43D742c7757ECD9E0` passed its strict end-to-end auditor. The final recurring candidate is `0x7C942fe70E1C7EA0cC2d1d37fad1018200C3e401`, wired to fresh coordinator `0xcb8bbD71B269E4a64965Cb86F044950f542B6133`. It holds two independently encrypted `1,000,000`-unit deposits and `500,000` units of disclosed testnet-sponsored encrypted prize funding. Its two-epoch transcript and strict audits are in progress.

The production-oriented React frontend is in [`frontend/`](./frontend). It implements live Sepolia reads, injected-wallet onboarding, lazy Zama browser-SDK encryption and owner decryption, encrypted deposits and withdrawals, recurring checkpoints, and two-step private claims. Writes remain intentionally gated until the final recurring audit and browser-wallet QA pass.
