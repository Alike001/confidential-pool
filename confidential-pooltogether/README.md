...
The Sepolia `cUSDTMock` target is read-only verified: chain ID `11155111`, 6 decimals, ERC-7984 support, and a valid wrapper-registry association. The corrected current lifecycle candidate at `0xa4f2c74Fe1325e218AC9cEDc176DA7C4e175f3a2` now has a successful encrypted `1,000,000`-unit principal deposit and user decryption proof. It points to the live RNG adapter and awaits encrypted yield funding before its post-epoch RNG-backed draw.
