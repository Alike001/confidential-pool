...
The Sepolia `cUSDTMock` target is read-only verified: chain ID `11155111`, 6 decimals, ERC-7984 support, and a valid wrapper-registry association. Live encrypted deposit/decryption and encrypted yield funding were proven on a historical integration pool. The corrected current lifecycle candidate is deployed at `0xa4f2c74Fe1325e218AC9cEDc176DA7C4e175f3a2`, points to the same wrapper and live RNG adapter, and awaits fresh deposit and yield funding before its post-epoch RNG-backed draw.
