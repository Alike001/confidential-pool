...
The Sepolia `cUSDTMock` target is read-only verified: chain ID `11155111`, 6 decimals, ERC-7984 support, and a valid wrapper-registry association. The corrected current lifecycle candidate at `0xa4f2c74Fe1325e218AC9cEDc176DA7C4e175f3a2` has completed encrypted deposit/yield funding, post-epoch Chainlink randomness, draw opening, encrypted winner evaluation, winner-only `100,000`-unit decryption, and confidential prize settlement. The guarded `1,000,000`-unit principal-withdrawal dry run passes; its live broadcast is the final bounded lifecycle step.
