...
The Sepolia `cUSDTMock` target is verified for the bounded prototype. Earlier pool `0xa4f2c74Fe1325e218AC9cEDc176DA7C4e175f3a2` completed the original bounded lifecycle. The focused local suite has 14 passing tests, including weighted two-user outcomes, RNG replay rejection, and coordinator-enforced post-epoch request provenance. Provenance-version-1 coordinator `0xabc4d6ca46A91cFF083cD0086B81337adC7ed6cA` and replacement pool `0xF99747C771c09909f6Ad56F43D742c7757ECD9E0` are deployed and verified; the replacement pool now holds a confirmed `1,000,000`-unit encrypted deposit. Its yield/draw/claim/withdrawal cycle, real yield, broader multi-user/full V5 scope, hardening, and frontend work remain.
