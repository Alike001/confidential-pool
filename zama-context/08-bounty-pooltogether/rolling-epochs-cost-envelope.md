...
The first one-transaction claim reached `4,682,000` HCU depth. A 64-bit widened `mulDiv` optimization reduced that only to `4,613,032`, leaving too little production margin. The final candidate therefore uses two confidential transactions:
...
|---|---:|---:|---:|---:|
| Deposit | 1,093,610 | 1,791,288 | 732,000 | 14.6% |
| Fund controlled yield | 884,935 | 1,435,160 | 732,000 | 14.6% |
| Partial withdrawal | 859,163 | 3,233,224 | 955,000 | 19.1% |
...
| Finalize KMS aggregate | 121,824 | 0 | 0 | 0% |
| Commit draw | 317,910 | 0 | 0 | 0% |
| Finalize draw | 64,807 | 0 | 0 | 0% |
| Prepare encrypted claim | 249,496 | 4,043,096 | 4,043,032 | 80.9% |
